...
public class PMM2_EndermanRenderer<T extends EndermanEntity> extends PMM2_BipedRenderer<T, PMM2_EndermanModel<T>> implements IEntityRenderer<T, PMM2_EndermanModel<T>>
{
    private static final ResourceLocation ENTITY_TEXTURES = new ResourceLocation("textures/entity/enderman/enderman-chan.png");
